describe("Automating EX201 - Import for Re-export ", () => {
    before(function () {
        ...
        cy.fixture("ex201reim.json").as("testData")
        // Set the viewport size for the tests
        cy.viewport(1024, 764)
    })
    it("EX201 - RImport for Re-export ", function () {
        ...
        cy.selectExcise(data.locators_ex201reim.EX201REIM_container_id,
            data.locators_ex201reim.EX201REIM_title_id,
            data.locators_ex201reim.EX201REIM_description_id,
            data.locators_ex.EX_createNew_id,
            "EX201",
            data.EntryValues.EX201REIM_Description
        )

        // validate the form page url
        cy.validateUrl(data.EntryValues.EX201REIM_url)

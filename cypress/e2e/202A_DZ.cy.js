...
describe('Captcha Handling Test', () => {
  ...
  it('should solve the captcha and log in', () => {
    ...
    cy.fixture('example').then((data) => {
      ...
      //202A DZ
      cy.scrollToView(data.Locators_202A.EX202A_createNew_xpath);
      cy.wait(3000)


      cy.waitAndClick(data.Locators_202A.EX202A_createNew_xpath);
      cy.wait(2000);

      cy.scrollToView(data.Locators_202A.Ex202A_checkBox_xpath);
      cy.wait(5000)

      cy.waitAndClick(data.Locators_202A.Ex202A_checkBox_xpath);
      cy.wait(3000)

      cy.waitAndClick(data.Locators_202A.Ex202A_start_xpath);
      cy.wait(5000)

      cy.inputField(data.Locators_202A.Ex202A_DZ_input_xpath,data.Locators_202A.Dz_input_value)
      cy.wait(3000)

      cy.waitAndClick(data.Locators_202A.validate_xpath)
      cy.wait(3000)

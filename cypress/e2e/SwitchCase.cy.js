      ...
      it("EX201 - Import", () => {
        ...
        cy.fixture("example1.json").then((data) => {
          ...
          cy.closePopupIfPresent(
            data.LocatorsPath.PopUp_Selector,
            data.LocatorsPath.PopUp_Accept
          );
          // Wait for the TRN validation element to be present
          cy.waitForXpathElementPresence(
            data.LocatorsPath.TRN_validation_Xpath
          );
          ...
          cy.selectExcise(
            data.locators_ex201im.EX201IM_container_id,
          ...
          // input date
          cy.selectingDate(
            data.locators_ex201im.EX201IM_date_id,
            data.EntryValues.EX201IM_date
          );
          // selecting Emirate of Import
          cy.clickElement(data.locators_ex201im.EX201IM_emirates_DropDown_id);
          cy.selectFromDropdown(
            data.locators_ex201im.EX201IM_emirates_list_id,
            data.EntryValues.EX201IM_emirates
          );
          // selecting Port of Entry
          cy.clickElement(data.locators_ex201im.EX201IM_Port_DropDown_id);
          cy.selectFromDropdown(
            data.locators_ex201im.EX201IM_port_list_id,
            data.EntryValues.EX201IM_port
          );
          ...
          // upload the file
          cy.uploadingFile(
            data.locators_ex201im.EX201IM_upload_id,
            data.EntryValues.EX201IM_filePath
          );
        });
      });
    });
    ...
    describe("Automating EX201 - Release from Designated Zone (Requiring Customs Clearance)", () => {
      ...
      it("EX201 - Release from Designated Zone (Requiring Customs Clearance)", () => {
        ...
        cy.fixture("example1.json").then((data) => {
          ...
          cy.selectFromDropdown(
            data.locators_ex201im.EX201IM_emirates_list_id,
            data.EntryValues.EX201DZ_emirates
          );
          // Entering DZ Zone ID
          cy.inputField(
            data.locators_ex201dz.EX201DZ_zone_id,
            data.EntryValues.EX201DZ_zone_number
          );
        });
      });
    });
    ...
    describe("Automating EX201 - Import for Re-export ", () => {
      ...
      it("EX201 - RImport for Re-export ", () => {
        ...
        cy.fixture("example1.json").then((data) => {
          ...
          cy.selectingDate(
            data.locators_ex201im.EX201IM_date_id,
            data.EntryValues.EX201REIM_date
          );
          // selecting Emirate of Import
          cy.clickElement(data.locators_ex201dz.EX201DZ_emirates_DropDown_id);
          cy.selectFromDropdown(
            data.locators_ex201im.EX201IM_emirates_list_id,
            data.EntryValues.EX201REIM_emirates
          );
          // selecting Port of Entry
          cy.clickElement(data.locators_ex201im.EX201IM_Port_DropDown_id);
          cy.selectFromDropdown(
            data.locators_ex201im.EX201IM_port_list_id,
            data.EntryValues.EX201REIM_port
          );
          //clicking on next button
          cy.clickXpathElement(data.locators_ex201im.EX201IM_next_xpath);
          cy.clickElement(data.locators_ex201im.EX201IM_download_id);
